...
const interview = [
  ...
  },
  {
    ...
    answer: ['儘管家境簡樸，我們依然在家的窗臺上種些盆栽。我外婆就是綠手指，凡經她手，欣欣向榮。茉莉花是我最愛的，在我的語言把它叫做「sampaguita」，它有小而潔白的花瓣，甚至在還只是蓓蕾時，就充滿濃郁的芬芳。它們像聚在枝頭上的小星星，掉落時我會將他們一頁一頁壓在書裡，當他們變成乾燥花時，香氣好像也未曾消散一樣，我喜歡種讓花朵永生的做法，也許你也可說茉莉花是世上眾多永恆的事物中，我們有幸能獲得的一種吧。'],
  },
]
