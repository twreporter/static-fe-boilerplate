...
const interview = [
  ...
  },
  {
    ...
    answer: ['對父母、妻子和兒子，我有跟他們提及我的戰鬥生活，但只一兩次，也只簡約得講。也是很久以前了，當我剛從戰場回來的時候，越到後來我越少提及戰爭的事。現在越南人常說「要讓過去沉睡」，意思是別忘記過去，但也別讓過去阻礙今日的生活。人生的記憶，特別是戰爭的記憶，對我而言，不肯能以尋常的言語來述說，而只能通過音樂和文學。'],
  },
  {
