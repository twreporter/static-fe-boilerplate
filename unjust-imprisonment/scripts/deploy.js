/* eslint no-console:0 */
const {
  copyFilesTo, setMetadata, uploadFiles, makePublic, getFiles, deleteFiles,
} = require('./gcs-helpers')
...
async function deploy({
  localFilesPath, publicDirName, targetSubfolderName, backupDirName, metadata, uploadConfigs,
}) {
  try {
