...
const slug = 'rent-house-in-difficulty-generation-gcs'
...
export const sectionDescription = [
  ...
  '老有所終，在高齡化的台灣竟成奢求。一群最需要改善居住安全與權益的老人，卻淪為租屋市場裡的人球，任由市場宰制⋯',
  '當發生火災，租客的權益該如何被保障？在租屋黑市下，政府很難去取締那些違法隔間、具有潛在安全性疑慮的出租套房⋯'
]
