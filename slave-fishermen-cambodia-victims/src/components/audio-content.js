...
import { IconContainerPrototype, OnlyDisplayOnTabletBelow, OnlyDisplayOnDesktopAbove} from './common-components'
...
const Story = styled.div`
  ...
  ${screen.mobileBelow`
    ...
    bottom: ${props => !props.ifPlaying && !props.hideonFirstTouch ? '50%' : '0'};
    transform: translate(0, ${props => !props.ifPlaying && !props.hideonFirstTouch ? '150%' : '0'});
