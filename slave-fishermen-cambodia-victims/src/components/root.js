...
export default class Root extends React.Component {
  constructor(props) {
    ...
    this._toggleHotjarWidget = this._toggleHotjarWidget.bind(this)
  }
      ...
      if (Component == HeaderOne) {
        ...
        return (
          <Component
            ...
            content={
              {
                url: 'https://www.twreporter.org/i/slave-fishermen-cambodia-victims-gcs',
                title: '深入柬埔寨──那些傷口無法癒合的漁工們',
              }
            }
          />
        )
